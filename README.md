        ...
        - - Official updater can't find firmware
          - - Update can't proceed
            ...
            - 1. Download and launch the official Attack Shark firmware updater.
              2. 2. When prompted for a device/firmware ID, enter **2268** (this is the X65HE's device ID, which isn't always obvious from the updater UI).
                 3. 3. If the updater finds firmware, let it download and flash normally.
